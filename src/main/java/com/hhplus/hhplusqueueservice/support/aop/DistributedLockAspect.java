package com.hhplus.hhplusqueueservice.support.aop;
...
import static com.hhplus.hhplusqueueservice.domain.common.exception.ErrorCode.LOCK_ACQUIRE_FAILED;
...
public class DistributedLockAspect {
    ...
    @Around("@annotation(com.hhplus.hhplusqueueservice.support.aop.DistributedLock)")
