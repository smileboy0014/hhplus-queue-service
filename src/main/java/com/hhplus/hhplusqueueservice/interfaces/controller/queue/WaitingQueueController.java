package com.hhplus.hhplusqueueservice.interfaces.controller.queue;

import com.hhplus.hhplusqueueservice.domain.queue.WaitingQueueService;
import com.hhplus.hhplusqueueservice.interfaces.common.dto.ApiResultResponse;
import com.hhplus.hhplusqueueservice.interfaces.controller.queue.dto.WaitingQueueDto;
import com.hhplus.hhplusqueueservice.support.aop.TraceLog;
...
public class WaitingQueueController {
    ...
    public ApiResultResponse<WaitingQueueDto.Response> checkWaiting(@RequestBody @Valid WaitingQueueDto.Request request) {
        return ApiResultResponse.ok(
                WaitingQueueDto.Response.of(waitingQueueService.checkWaiting(request.toCreateCommand())));
    }
}
